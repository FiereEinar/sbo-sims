...
type MobileSidebarGroupProps = {
  link: SidebarNavLinkType;
};

export default function MobileSidebarGroup({ link }: MobileSidebarGroupProps) {
  ...
  return (
    ...
    >
      ...
      <CollapsibleContent className="flex flex-col gap-5 pl-2 pt-2 overflow-hidden data-[state=closed]:hidden data-[state=closed]:animate-collapsible-up data-[state=open]:animate-collapsible-down">
