...
function TableHeadCourseFilter() {
  ...
  return (
    <Select defaultValue="All" onValueChange={(value) => setCourse(value)}>
...
function TableHeadYearFilter() {
  ...
  return (
    <Select
      defaultValue="All"
      onValueChange={(value) => setYear(value === 'All' ? undefined : value)}
    >
...
function TableHeadSectionFilter() {
  ...
  return (
    <Select
      ...
      onValueChange={(value) => setSection(value === 'All' ? undefined : value)}
    >
      <SelectTrigger className="w-full border-none pl-0 focus:ring-0 min-w-[90px]">
