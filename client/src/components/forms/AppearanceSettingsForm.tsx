...
export default function AppearanceSettingsForm() {
  ...
  const isCustom =
    primaryColor && !PRESETS.find((p) => p.value === primaryColor);
      ...
      <CardContent className="space-y-6">
        <div className="space-y-3">
          ...
          <div className="flex flex-wrap gap-4 items-center">
            ...
            >
              <div
                className={`flex h-12 w-12 items-center justify-center rounded-full border-2 ${primaryColor === null ? 'border-primary bg-primary/10' : 'border-border bg-muted'}`}
              >
            ...
            <div className="relative flex flex-col items-center justify-center gap-2 transition-all ml-2">
              <label
                ...
                className={`cursor-pointer ${isCustom ? 'scale-110 opacity-100' : 'opacity-70 hover:opacity-100'}`}
              >
                <div
